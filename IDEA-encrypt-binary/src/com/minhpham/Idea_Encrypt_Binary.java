...
class Idea_Encrypt_Binary {
    ...
    // Tạo 52 khóa con
    private static String[] generateSubKey(String key) {
        if (key.length() < 128) {
    ...
    // Mã hóa
    private static String encrypt(String plainText, String[] subKey) {
    ...
    // Giải mã
    private static String decrypt(String cipherText, String[] subKey) {
        String d[] = new String[15];
